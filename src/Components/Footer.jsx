...
const Footer = () => {
  ...
  <footer className="main-footer">
   <div className='down-broch'>
    <a href='#'> Download Brochure <i class="fa fa-download"></i> </a>
   </div>
   <div className="whatsapp">
    <a
      href="https://api.whatsapp.com/send?phone=919910371444&text=I am interested in your service"
      target="_blank"
    >
      <img
    ...
    <div className="cat-footer-wrapper relative">
      <div className="top-right-shap bouncing">
        <img src="img/scrool-up.png" alt="" />
      </div>
      <div className="container">
        <div className="row">
          <div className="col-xl-3 col-lg-3 col-md-6 col-12">
            <div className="cat-widget cat-foot-about">
              <h4 className="footer-title">About Building</h4>
              <p>
              Trusted by 200 + satisfied clients tallest commercial tower in NCR region
              an icon in eternity Going to the mall   <a className='foot-rd' href='#'>Read More..</a>
              </p>
              ...
              <div className="footer-menu contact-menu">
                <ul>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      <span>
                      <i class="fa fa-envelope" style={{ color: "#36579a", fontSize: 18 }}></i>
                      </span>
                      <p>24/7 Hours Service</p>
                    </a>
                  </li>
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-12">
            <div className="cat-widget cat-foot-menu">
              <h4 className="footer-title">Social Gallery</h4>
  ...
  <a href="#" className="scroll-to-topp">
